...
  }
  if (! message.guild.member (client.user) .hasPermission ("BAN_MEMBERS")) return message.channel.send (`** ${message.author.tag} ** Sorry, Im Doesn t Have Permissions \ BAN_MEMBERS Please give me Permissions to Member Tires:) `) .then (msg => msg.delete (5000))
  
